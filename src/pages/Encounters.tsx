...
export function Encounters() {
  ...
  if (error) {
    return (
      <ErrorState error={error} onRetry={handleRetry} retrying={retrying} />
    );
  }
        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="bg-white rounded-lg shadow-sm p-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-6">
              Care Settings Analysis
            </h1>
            <p className="text-gray-600 mb-8">
              Analyze and optimize healthcare delivery across different care
              settings to ensure efficient resource utilization and improved
              patient outcomes. Monitor encounter distributions and identify
              opportunities for care setting optimization.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-emerald-50 rounded-lg p-6">
                ...
                <p className="text-gray-600">
                  Track encounter distribution across care settings and analyze
                  patterns to identify areas for service delivery optimization.
                </p>
              </div>
              ...
              <div className="bg-emerald-50 rounded-lg p-6">
                ...
                <p className="text-gray-600">
                  Identify opportunities to shift care to more appropriate
                  settings while maintaining quality and improving efficiency.
                </p>
              </div>
            </div>
          </div>
