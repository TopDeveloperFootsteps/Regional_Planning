        ...
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Healthcare Infrastructure Planning</p>
            </div>
          </Link>
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link 
              to="/services-and-cs" 
              className={`text-gray-600 hover:text-emerald-600 transition-colors font-medium ${
                location.pathname.startsWith('/services-and-cs') ? 'text-emerald-600' : ''
              }`}
            >
              Services & CS
            </Link>
            ...
            <Link 
              to="/demand-capacity" 
              className={`text-gray-600 hover:text-emerald-600 transition-colors font-medium ${
                location.pathname === '/demand-capacity' ? 'text-emerald-600' : ''
              }`}
            >
              D&C Output
            </Link>
