...
const INITIAL_DATA: AgeGroupData[] = [
  {
    ...
    ...Object.fromEntries(
      YEARS.map((year, i) => [
        year,
        [
          0.0167, 0.02, 0.0267, 0.03, 0.0333, 0.04, 0.06, 0.06, 0.06, 0.06,
  ...
  {
    ageGroup: "5 to 19",
    ...Object.fromEntries(YEARS.map(() => [YEARS[0], 0.1525])),
  },
  {
    ageGroup: "20 to 29",
    ...Object.fromEntries(
      YEARS.map((year, i) => [
        year,
        [
          0.1919, 0.1858, 0.1836, 0.1825, 0.1764, 0.1742, 0.1675, 0.1675,
          0.1625, 0.1625, 0.1625, 0.1625, 0.1625, 0.1575, 0.1575, 0.1575,
        ][i],
      ])
    ),
  },
  {
    ...
    ...Object.fromEntries(
      YEARS.map((year, i) => [
        year,
        [
          0.3394, 0.3333, 0.3311, 0.33, 0.3239, 0.3217, 0.315, 0.315, 0.31,
          0.31, 0.31, 0.31, 0.31, 0.305, 0.305, 0.305,
        ][i],
      ])
    ),
  },
  {
    ...
    ...Object.fromEntries(
      YEARS.map((year, i) => [
        year,
        [
          0.2894, 0.2883, 0.2861, 0.285, 0.2839, 0.2817, 0.275, 0.275, 0.275,
                ...
                {YEARS.map((year) => (
                  ...
                  >
                    <input
                      ...
                      onChange={(e) =>
                        handleValueChange(row.ageGroup, year, e.target.value)
                      }
