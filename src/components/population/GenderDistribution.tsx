  ...
  },
  {
    ...
    ...Object.fromEntries(
      YEARS.map((year, i) => [
        year,
        [
          0.57, 0.56, 0.56, 0.56, 0.56, 0.55, 0.55, 0.54, 0.54, 0.53, 0.53,
  ...
  },
  {
    ...
    ...Object.fromEntries(
      YEARS.map((year, i) => [
        year,
        [
          0.7, 0.69, 0.69, 0.68, 0.67, 0.65, 0.64, 0.63, 0.61, 0.6, 0.59, 0.58,
          0.57, 0.56, 0.55, 0.54,
        ][i],
      ])
    ),
  },
  {
    ...
    ...Object.fromEntries(
      YEARS.map((year, i) => [
        year,
        [
          0.7, 0.69, 0.68, 0.67, 0.66, 0.64, 0.63, 0.62, 0.6, 0.59, 0.58, 0.57,
          0.56, 0.55, 0.54, 0.54,
        ][i],
      ])
    ),
  },
  {
    ...
    ...Object.fromEntries(
      YEARS.map((year, i) => [
        year,
        [
          0.7, 0.69, 0.68, 0.67, 0.66, 0.65, 0.63, 0.62, 0.61, 0.59, 0.58, 0.57,
          0.55, 0.54, 0.53, 0.53,
        ][i],
      ])
    ),
  },
  {
    ...
    ...Object.fromEntries(
      YEARS.map((year, i) => [
        year,
        [
          0.48, 0.47, 0.47, 0.47, 0.47, 0.46, 0.46, 0.46, 0.45, 0.45, 0.45,
...
export function GenderDistribution() {
  ...
  const [baselineData, setBaselineData] =
    useState<GenderData[]>(INITIAL_MALE_DATA);
  ...
  const femaleData = maleData.map((maleRow) => ({
    ...
    ...Object.fromEntries(
      YEARS.map((year) => [year, 1 - (maleRow[year] as number)])
    ),
  }));

  const handleMaleValueChange = (
    ageGroup: string,
    year: number,
    value: number | string
  ) => {
    ...
    setMaleData((prevData) =>
      prevData.map((row) =>
        row.ageGroup === ageGroup ? { ...row, [year]: numValue } : row
      )
    );
  };
