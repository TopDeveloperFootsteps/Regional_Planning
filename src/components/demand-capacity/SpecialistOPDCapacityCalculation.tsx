...
export function SpecialistOPDCapacityCalculation() {
  ...
  const calculateAndSaveSlots = async (
    ...
    try {
      ...
      const { error } = await supabase
        .from('specialist_opd_capacity')
        .upsert(
          calculations.map(calc => ({
            specialty: calc.service,
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-6">Specialist OPD Slot Calculations</h2>
