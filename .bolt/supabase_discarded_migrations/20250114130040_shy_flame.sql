-- Insert data from hospital_codes to hospital_services_mapping
...
SELECT 
    ...
    'Initial mapping from hospital_codes' -- Default mapping logic
FROM hospital_codes codes;

-- Create a view to monitor the data transfer
CREATE OR REPLACE VIEW hospital_mapping_status AS
SELECT 
...
FROM hospital_codes codes
LEFT JOIN hospital_services_mapping mapping ON codes."ICD FamilyCode" = mapping.icd_code;