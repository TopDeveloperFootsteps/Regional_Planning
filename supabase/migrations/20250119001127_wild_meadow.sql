...
-- Create encounters_statistics view with percentages
...
SELECT 
  ...
  ROUND((total_encounter_count::numeric / t.total * 100), 1) as encounter_percentage
FROM stats, total_encounters t
ORDER BY total_encounter_count DESC;

-- Create system_of_care_analysis view with care setting percentages
...
SELECT 
  ...
  jsonb_object_agg(
    ...
    END,
    ROUND((cs.setting_encounters::numeric / cs.total_system_encounters * 100), 1)
