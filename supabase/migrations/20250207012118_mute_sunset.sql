...
ALTER TABLE population_data DROP CONSTRAINT IF EXISTS population_data_default_factor_check;

-- Update existing records to match required values
...
-- Create function to set default values for new population data entries
...
-- Add constraint for population type rules
