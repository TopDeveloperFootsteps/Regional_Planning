...
DROP TRIGGER IF EXISTS set_planning_family_service_trigger ON planning_family_code;
...
-- Ensure index exists for service column
CREATE INDEX IF NOT EXISTS idx_planning_family_code_service
