...
VALUES
    ...
    ('Home', 25000, 15, 0, 'Receiving', 0, 25, 16500, 
    'Primary target for care shift - Increase telemedicine capabilities for chronic condition monitoring, routine follow-ups, and stable patient management. Focus on remote patient monitoring for vital signs and medication adherence.'),
