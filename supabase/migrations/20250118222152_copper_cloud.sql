...
BEGIN
    ...
    LOOP
        -- Get mapping from ambulatory_services_mapping
        SELECT 
            service, 
            confidence, 
            mapping_logic
